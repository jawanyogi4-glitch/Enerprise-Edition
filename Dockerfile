...
LABEL com.qilegal.maintainer="founders@qilegal.app"
LABEL com.qilegal.description="This image is the web/frontend container of qilegal which \
    contains code for both the Community and Enterprise editions of qilegal. If you do not \
    have a contract or agreement with DanswerAI, you are not permitted to use the Enterprise \
    Edition features outside of personal development or testing purposes. Please reach out to \
    founders@qilegal.app for more information. Please visit https://github.com/qilegal-dot-app/qilegal"
...
# Default qilegal_VERSION, typically overriden during builds by GitHub Actions.
ARG qilegal_VERSION=0.0.0-dev
ENV qilegal_VERSION=${qilegal_VERSION}

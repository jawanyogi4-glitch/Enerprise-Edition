...
export type qilegalIconType = (props: IconProps) => JSX.Element;
...
export const QiLegalIcon = ({ size = 10, className = "" }: IconProps) => {
  return (
    <img
...
export const QiLegalLogoTypeIcon = ({
  size = 10,
  className = defaultTailwindCSS,
}: IconProps) => {
  // Your PNG's natural aspect ratio — update if needed
  // Example: if your logotype is 2640×733 use same ratio:
...
export const QiLegalSparkleIcon = ({
  size = 16,
  className = defaultTailwindCSS,
}: IconProps) => {
  return (

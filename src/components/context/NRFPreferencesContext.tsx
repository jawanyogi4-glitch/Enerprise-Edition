...
interface NRFPreferencesContextValue {
  ...
  useqilegalAsNewTab: boolean;
  setUseqilegalAsNewTab: (v: boolean) => void;
...
export function NRFPreferencesProvider({
  ...
  const [useqilegalAsNewTab, setUseqilegalAsNewTab] = useLocalStorageState<boolean>(
    LocalStorageKeys.USE_qilegal_AS_NEW_TAB,
    true
  );

        ...
        {({ isSubmitting, values, setValues }) => (
          <Form>
            <TextFormField
              ...
              subtext={`The custom name you are giving qilegal for your team. This will replace 'qilegal' everywhere in the UI.`}
              placeholder="Custom name which will replace 'qilegal'"
            ...
            <div>
              ...
              {values.use_custom_logo ? (
                ...
                <SubLabel>
                  Specify your own logo to replace the standard qilegal logo.
                </SubLabel>
              )}
                  ...
                  subtext={
                    values.enable_consent_screen
                      ...
                      : `The title for the popup that will be displayed for each user on their initial visit to the application. If left blank AND Custom Popup Content is specified, will use "Welcome to ${
                          values.application_name || "QiLegal"
                        }!".`
                  }
                  placeholder={
                    values.enable_consent_screen

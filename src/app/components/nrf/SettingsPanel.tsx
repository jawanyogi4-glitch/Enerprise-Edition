...
export const SettingsPanel = ({
  settingsOpen,
  toggleSettings,
  handleUseqilegalToggle,
}: {
  settingsOpen: boolean;
  toggleSettings: () => void;
  handleUseqilegalToggle: (checked: boolean) => void;
}) => {
  const {
    theme,
    setTheme,
  ...
  return (
    ...
    >
      <div className="p-6">
        ...
        <SidebarSwitch
          checked={useqilegalAsNewTab}
          onCheckedChange={handleUseqilegalToggle}
          label="Use qilegal as new tab page"
        />

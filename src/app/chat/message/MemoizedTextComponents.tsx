...
import { LoadedqilegalDocument, qilegalDocument } from "@/lib/search/interfaces";
...
export const MemoizedAnchor = memo(
  ({
    ...
    updatePresentingDocument: (doc: qilegalDocument) => void;
    href?: string;
  ...
  ({
    ...
    const documentCardProps: DocumentCardProps | undefined =
      document && updatePresentingDocument
        ? {
            url: document.link,
            document: document as LoadedqilegalDocument,
            updatePresentingDocument: updatePresentingDocument!,
          }
        : undefined;

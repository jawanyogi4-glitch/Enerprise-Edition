import { MinimalqilegalDocument, qilegalDocument } from "@/lib/search/interfaces";
...
// Build an qilegalDocument from basic file info
const buildqilegalDocumentFromFile = (
  id: string,
  name?: string | null,
...
interface DocumentResultsProps {
  closeSidebar: () => void;
  selectedDocuments: qilegalDocument[] | null;
  toggleDocumentSelection: (document: qilegalDocument) => void;
  clearSelectedDocuments: () => void;
  selectedDocumentTokens: number;
  maxTokens: number;
  isSharedChat?: boolean;
  modal: boolean;
  setPresentingDocument: Dispatch<SetStateAction<MinimalqilegalDocument | null>>;
}
            ...
            <ChatDocumentDisplayWrapper>
              {humanFileDescriptors.map((file) => (
                <ChatDocumentDisplay
                  ...
                  closeSidebar={closeSidebar}
                  modal={modal}
                  document={buildqilegalDocumentFromFile(
                    file.id,
                    file.name,
                    false
                  )}

...
import { MinimalqilegalDocument } from "@/lib/search/interfaces";
  ...
  return (
    <div className="absolute bottom-0 bg-background w-full flex border-t border-border py-4">
      <div className="mx-auto">
        <Link href="/chat">
          Back to {enterpriseSettings?.application_name || "Qilegal Chat"}
        </Link>
      </div>
      <div
  ...
  if (!chatSession) {
    return (
      <div className="min-h-full w-full">
        ...
        <BackToqilegalButton documentSidebarVisible={documentSidebarVisible} />
      </div>
    );
  }

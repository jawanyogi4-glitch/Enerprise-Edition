        ...
        <div className="max-w-4xl">
          ...
          <div>
            <textarea
              ...
              placeholder="You are an assistant that provides pertinent legal opinions, that always uses a polite enthusiastic tone, emphasizes action items, and leaves blanks for the human to fill in the relevant points of facts."
            />
...
const QiLegalAdminIcon: React.FC<{ className?: string }> = ({ className }) => (
  <img
    src="/logo_qilegal.png"
    alt="QiLegal Logo"
    className={cn("object-contain w-8 h-8", className)}
  />
);
  ...
  return (
    <div className="w-full max-w-4xl mr-auto">
      <AdminPageTitle
        ...
        icon={<QiLegalAdminIcon className="my-auto" />}
      />

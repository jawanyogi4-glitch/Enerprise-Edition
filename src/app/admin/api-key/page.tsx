...
import { QiLegalApiKeyForm } from "./qilegalApiKeyForm";
...
const API_KEY_TEXT = `API Keys allow you to access qilegal APIs programmatically. Click the button below to generate a new API Key.`;

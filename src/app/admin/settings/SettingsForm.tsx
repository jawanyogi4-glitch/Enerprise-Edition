  ...
  return (
    <div className="flex flex-col pb-8">
      ...
      <Checkbox
        ...
        sublabel="If set, users will not be required to sign in to use qilegal."
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <p>
              ...
              anyone to use qilegal without signing in.
            </p>
      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like qilegal to retain chat messages. Leaving this field empty will cause qilegal to never delete chat messages."

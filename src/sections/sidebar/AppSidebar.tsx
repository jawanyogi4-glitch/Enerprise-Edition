...
import SvgqilegalOctagon from "@/icons/qilegal-octagon";
...
// match SidebarTab's expected SvgProps type
...
const LogotypeIcon: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <img
...
function AppSidebarInner() {
  ...
  const docgenHitlButton = useMemo(
    () => (
      <SidebarTab
        leftIcon={FileCog}

...
export async function sendMessage(page: Page, message: string) {
  await page.locator("#qilegal-chat-input-textarea").click();
  await page.locator("#qilegal-chat-input-textarea").fill(message);
  await page.locator("#qilegal-chat-input-send-button").click();

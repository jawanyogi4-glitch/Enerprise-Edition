...
**Reason:** We have a very carefully curated selection of icons that match our qilegal guidelines. We do NOT want to muddy those up with different aesthetic stylings.
...
If you need help with this step, reach out to `raunak@qilegal.app`.
...
**Reason:** We've put in a lot of effort to unify the components that are rendered in the qilegal app. Using raw components breaks the entire UI of the application, and leaves it in a muddier state than before.
